    ...
    for (int j = 0; j < cctk_lsh[1]; ++j) {
      for (int i = 0; i < cctk_lsh[0]; ++i) {
        ...
        */
        ...
        gxx[ind] = gxx[ind] + Gb[1][1] - 1.0;
        gxy[ind] = gxy[ind] + Gb[1][2];
        gxz[ind] = gxz[ind] + Gb[1][3];
        gyy[ind] = gyy[ind] + Gb[2][2] - 1.0;
        gyz[ind] = gyz[ind] + Gb[2][3];
        gzz[ind] = gzz[ind] + Gb[3][3] - 1.0;
        ...
        */
        ...
        if (CCTK_EQUALS(initial_shift, "PS_single")) {
          betax[ind] = betax[ind] + W[ind] * y1rest;
          betay[ind] = betay[ind] - W[ind] * x1rest;
