    ...
    for (int j = 0; j < cctk_lsh[1]; ++j) {
     ...
     z0 (for instance) */
        ...
        */
        ...
        dG[1][1][1] = (2 * exp(2. * F1_1[ind]) * x1_1 * gamma * (pow(y1_1, 2) + x1_1 * gamma * (pow(x1_1 * gamma, 2) + pow(y1_1, 2)) * dF1_1_dx) + 2 * exp(2. * F2_1[ind]) * pow(y1_1, 2) * (-x1_1 * gamma + (pow(x1_1 * gamma, 2) + pow(y1_1, 2)) * dF2_1_dx)) / pow(pow(x1_1 * gamma, 2) + pow(y1_1, 2), 2);
        ...
        gammaA_inv[1][1] = 1 / ((-(pow(bs_v, 2) * exp(2. * F0_1[ind])) +
                                 (exp(2 * (F1_1[ind] + F2_1[ind])) * (pow(x1_1 * gamma, 2) +
                                                                      pow(y1_1, 2))) /
                                     (exp(2. * F2_1[ind]) * pow(x1_1 * gamma, 2) + exp(2. *
                                                                                       F1_1[ind]) *
                                                                                       pow(y1_1, 2))) *
                                pow(gamma, 2));
        gammaA_inv[1][2] = ((-exp(2. * F1_1[ind]) + exp(2. *
                                                        F2_1[ind])) *
                            x1_1 * gamma * y1_1) /
                           ((exp(2 * (F1_1[ind] + F2_1[ind])) * (pow(x1_1 * gamma, 2) + pow(y1_1, 2)) - pow(bs_v, 2) * exp(2. * F0_1[ind]) * (exp(2. * F2_1[ind]) * pow(x1_1 * gamma, 2) + exp(2. * F1_1[ind]) * pow(y1_1, 2))) * gamma);
        gammaA_inv[1][3] = 0;
        gammaA_inv[2][1] = gammaA_inv[1][2];
        gammaA_inv[2][2] = (exp(2. * F1_1[ind]) * pow(x1_1 * gamma, 2) + exp(2. * F2_1[ind]) * pow(y1_1, 2) -
                            pow(bs_v, 2) * exp(2. * F0_1[ind]) * (pow(x1_1 * gamma, 2) + pow(y1_1, 2))) /
                           (exp(2 * (F1_1[ind] + F2_1[ind])) * (pow(x1_1 * gamma, 2) + pow(y1_1, 2)) - pow(bs_v, 2) * exp(2. * F0_1[ind]) * (exp(2. * F2_1[ind]) * pow(x1_1 * gamma, 2) + exp(2. * F1_1[ind]) * pow(y1_1, 2)));
        gammaA_inv[2][3] = 0;
        ...
        const CCTK_REAL dA1x_dx = (-(R_x_1 * ((cosph * costh_1 * H2_1[ind] + H1r_1[ind] * x1_1 * gamma) * coswt -
                                              H3_1[ind] * sinph * sinwt)) +
                                   rr_1 * (-((d_sinph_dx * H3_1[ind] +
                                              dH3_dx * sinph) *
                                             sinwt) +
                                           coswt * (H1r_1[ind] + costh_1 * (cosph * dH2_dx + d_cosph_dx * H2_1[ind]) + dH1r_dx * x1_1 * gamma + cosph * H2_1[ind] * (-sinth_1 * th_x_1)))) /
                                  rr2_1;
        const CCTK_REAL dA1x_dy = (-(R_y_1 * ((cosph * costh_1 * H2_1[ind] + H1r_1[ind] * x1_1 * gamma) * coswt -
                                              H3_1[ind] * sinph * sinwt)) +
                                   rr_1 * (-((d_sinph_dy * H3_1[ind] +
                                              dH3_dy * sinph) *
                                             sinwt) +
        ...
        const CCTK_REAL dA1y_dx = (-(R_x_1 * ((costh_1 * H2_1[ind] * sinph + H1r_1[ind] * y1_1) * coswt +
                                   ...
                                   rr_1 * ((cosph * dH3_dx +
                                            d_cosph_dx * H3_1[ind]) *
                                               sinwt +
                                           coswt * (costh_1 * (d_sinph_dx * H2_1[ind] +
                                                               dH2_dx * sinph) +
                                                    dH1r_dx * y1_1 + H2_1[ind] * sinph * (-sinth_1 * th_x_1)))) /
                                  rr2_1;
        ...
        const CCTK_REAL dA1z_dx = (coswt * (R_x_1 * (H2_1[ind] * sinth_1 - H1r_1[ind] * z1_1) +
                                            rr_1 * (-(dH2_dx * sinth_1) + dH1r_dx * z1_1 - H2_1[ind] * costh_1 * th_x_1))) /
                                  rr2_1;
        const CCTK_REAL dA1z_dy = (coswt * (R_y_1 * (H2_1[ind] * sinth_1 - H1r_1[ind] * z1_1) +
                                            rr_1 * (-(dH2_dy * sinth_1) + dH1r_dy * z1_1 - H2_1[ind] * costh_1 * th_y_1))) /
                                  rr2_1;
        const CCTK_REAL dA1z_dz = (coswt * (H2_1[ind] * R_z_1 * sinth_1 + H1r_1[ind] * (rr_1 - R_z_1 * z1_1) +
                                            rr_1 * (-(dH2_dz * sinth_1) + dH1r_dz * z1_1 - H2_1[ind] * costh_1 * th_z_1))) /
                                  rr2_1;

        const CCTK_REAL dA2x_dx = (R_x_1 * (H3_1[ind] * sinph * coswt + (cosph * costh_1 * H2_1[ind] +
                                                                         H1r_1[ind] * x1_1 * gamma) *
                                                                            sinwt) +
                                   rr_1 * (-((d_sinph_dx * H3_1[ind] +
                                              dH3_dx * sinph) *
                                             coswt) -
                                           sinwt * (H1r_1[ind] + costh_1 * (cosph * dH2_dx + d_cosph_dx * H2_1[ind]) + dH1r_dx * x1_1 * gamma + cosph * H2_1[ind] * (-sinth_1 * th_x_1)))) /
                                  rr2_1;
        ...
        const CCTK_REAL dA2y_dx = (R_x_1 * (-(cosph * H3_1[ind] * coswt) + (costh_1 * H2_1[ind] * sinph +
                                   ...
                                   rr_1 * ((cosph * dH3_dx +
                                            d_cosph_dx * H3_1[ind]) *
                                               coswt -
                                           sinwt * (costh_1 * (d_sinph_dx * H2_1[ind] +
                                                               dH2_dx * sinph) +
                                                    dH1r_dx * y1_1 + H2_1[ind] * sinph * (-sinth_1 * th_x_1)))) /
                                  rr2_1;
